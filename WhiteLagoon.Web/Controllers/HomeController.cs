...
namespace WhiteLagoon.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        IWebHostEnvironment _webHostEnvirontment;
        ...
        public IActionResult GeneratePPTExport(int id)
        {
            ...
            string basePath = _webHostEnvirontment.WebRootPath;
            ...
            if (shape is not null)
            {
                ...
                double[] size = [shape.Left, shape.Top, shape.Width, shape.Height];
                slide.Shapes.Remove(shape);
                using MemoryStream imageStream = new(imageData);
                IPicture newPicture = slide.Pictures.AddPicture(imageStream, size[0], size[1], size[2], size[3]);
            }
